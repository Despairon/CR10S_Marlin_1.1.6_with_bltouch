...
#include "dogm_font_data_ISO10646_1.h" // English
#include "dogm_font_data_ISO10646_5_Cyrillic.h" // Ukrainian
...
#define FONT_MENU_NAME_UK ISO10646_5_Cyrillic_5x7
...
static char lcd_print_and_count(const char c);
static void lcd_print(const char *str);
static void lcd_printPGM(const char *str);
static void lcd_print_utf(const char *str, uint8_t n=LCD_WIDTH);
static void lcd_printPGM_utf(const char *str, uint8_t n=LCD_WIDTH);
  ...
  static void lcd_implementation_mark_as_selected(const uint8_t row, const bool isSelected);
    ...
    static void lcd_custom_bootscreen();
  #endif // SHOW_CUSTOM_BOOTSCREEN
#endif

// LCD selection
#if ENABLED(REPRAPWORLD_GRAPHICAL_LCD)
  static U8GLIB_ST7920_128X64_4X u8g(LCD_PINS_RS); // 2 stripes
  // U8GLIB_ST7920_128X64 u8g(LCD_PINS_RS); // 8 stripes
#elif ENABLED(U8GLIB_ST7920)
  static U8GLIB_ST7920_128X64_RRD u8g(0); // Number of stripes can be adjusted in ultralcd_st7920_u8glib_rrd.h with PAGE_HEIGHT
#elif ENABLED(CARTESIO_UI)
  // The CartesioUI display
  #if DOGLCD_MOSI != -1 && DOGLCD_SCK != -1
    // using SW-SPI
    //U8GLIB_DOGM128 u8g(DOGLCD_SCK, DOGLCD_MOSI, DOGLCD_CS, DOGLCD_A0);  // 8 stripes
    static U8GLIB_DOGM128_2X u8g(DOGLCD_SCK, DOGLCD_MOSI, DOGLCD_CS, DOGLCD_A0); // 4 stripes
  #else
    //U8GLIB_DOGM128 u8g(DOGLCD_CS, DOGLCD_A0);  // 8 stripes
    static U8GLIB_DOGM128_2X u8g(DOGLCD_CS, DOGLCD_A0); // 4 stripes
  #endif
#elif ENABLED(U8GLIB_LM6059_AF)
  // Based on the Adafruit ST7565 (http://www.adafruit.com/products/250)
  //U8GLIB_LM6059 u8g(DOGLCD_CS, DOGLCD_A0);  // 8 stripes
  static U8GLIB_LM6059_2X u8g(DOGLCD_CS, DOGLCD_A0); // 4 stripes
  ...
  static U8GLIB_ST7565_64128n_2x_VIKI u8g(DOGLCD_SCK, DOGLCD_MOSI, DOGLCD_CS, DOGLCD_A0);  // using SW-SPI
  //U8GLIB_NHD_C12864_2X u8g(DOGLCD_CS, DOGLCD_A0); // 4 stripes  HWSPI
#elif ENABLED(U8GLIB_SSD1306)
  // Generic support for SSD1306 OLED I2C LCDs
  //U8GLIB_SSD1306_128X64 u8g(U8G_I2C_OPT_NONE | U8G_I2C_OPT_FAST);  // 8 stripes
  static U8GLIB_SSD1306_128X64_2X u8g(U8G_I2C_OPT_NONE | U8G_I2C_OPT_FAST); // 4 stripes
#elif ENABLED(MKS_12864OLED)
  // MKS 128x64 (SH1106) OLED I2C LCD
  static U8GLIB_SH1106_128X64 u8g(DOGLCD_SCK, DOGLCD_MOSI, DOGLCD_CS, DOGLCD_A0);      // 8 stripes
  ...
  static U8GLIB_SH1106_128X64_2X u8g(U8G_I2C_OPT_NONE | U8G_I2C_OPT_FAST); // 4 stripes
#elif ENABLED(MINIPANEL)
  // The MINIPanel display
  //U8GLIB_MINI12864 u8g(DOGLCD_CS, DOGLCD_A0);  // 8 stripes
  static U8GLIB_MINI12864_2X u8g(DOGLCD_CS, DOGLCD_A0); // 4 stripes
#else
  // for regular DOGM128 display with HW-SPI
  //U8GLIB_DOGM128 u8g(DOGLCD_CS, DOGLCD_A0);  // HW-SPI Com: CS, A0  // 8 stripes
  static U8GLIB_DOGM128_2X u8g(DOGLCD_CS, DOGLCD_A0);  // HW-SPI Com: CS, A0 // 4 stripes
#endif

#if ENABLED(ULTIPANEL)
  static uint8_t row_y1, row_y2;
  static uint8_t constexpr row_height = DOG_CHAR_HEIGHT;
#endif

static char currentfont = 0;

// The current graphical page being rendered
static u8g_page_t &page = ((u8g_pb_t *)((u8g.getU8g())->dev->dev_mem))->p;

U8GLIB *u8g_ptr = static_cast<U8GLIB*>(&u8g);

extern char lcd_status_message[3 * (LCD_WIDTH) + 1]; // worst case is kana with up to 3*LCD_WIDTH+1
...
void lcd_implementation_clear() { 
  // Do nothing - automatically cleared by Picture Loop
}
  ...
  if (PAGE_UNDER(28)) 
  {
    ...
    if (IS_SD_PRINTING)
    {
      ...
      if (PAGE_CONTAINS(50, 51))     // 50-51 (or just 50)
      {
        u8g.drawBox(
          PROGRESS_BAR_X + 1, 50,
          (uint16_t)((PROGRESS_BAR_X - 1) * card.percentDone() * 0.01), 2
        );
      }
...
static void lcd_printPGM(const char *str) { 
  while (const char c = pgm_read_byte(str)) lcd_print(c), ++str;
}
