...
#define STRING_CONFIG_H_AUTHOR "(Despairon (maxdespairon@gmail.com))" // Who made the changes.
...
#define Z_MAX_POS 130 // TODO: BLTouch wires are too short to go any higher!
